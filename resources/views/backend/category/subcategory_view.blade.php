               ...
               <div class="box-body">
                   <div class="table-responsive">
                     <table id="example1" class="table table-bordered table-striped">
                       <thead>
                           <tr>
                               <th width="25%" style="padding: 5px">Sub Category Name English</th>
                               <th width="25%" style="padding: 5px">Sub Category Name Bangla</th>
                               <th width="25%" style="padding: 5px">Parent Category</th>
                       ...
                       <tbody>
                        ...
                        <tr>
                            <td width="25%" style="padding: 5px">{{ $subcategory->subcategory_name_en }}</td>
                            <td width="25%" style="padding: 5px">{{ $subcategory->subcategory_name_bn }}</td>
                            <td width="25%" style="padding: 5px">{{ $subcategory['category']['category_name_en'] }}</td>
                   ...
                   <form method="POST" action="{{ route('subcategory.store') }}">
                    @csrf
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="subcategory_name_en" value="{{ old('subcategory_name_en') }}" class="form-control"> <div class="help-block"></div></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="subcategory_name_bn" value="{{ old('subcategory_name_bn') }}" class="form-control"> <div class="help-block"></div></div>
